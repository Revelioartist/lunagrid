  ...
  return (
    <>
      ...
      <button
        ...
        className={cn(
          "md:hidden fixed top-4 left-4 z-50 rounded-2xl border backdrop-blur p-3",
          "transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]",
          "hover:scale-[1.02] active:scale-95",
          "border-black/10 dark:border-white/10",
          "bg-white/70 dark:bg-white/5",
      ...
      {mobileOpen && (
        <div className="md:hidden fixed inset-0 z-40">
          <div
            ...
            tabIndex={0}
          />
          <div className="absolute left-0 top-0 h-full w-20 p-4 flex flex-col gap-3 bg-white/70 dark:bg-slate-950/45 border-r border-black/10 dark:border-white/15 backdrop-blur-xl">
            <NavItem
              id="eth"
              label="ETH Data"
              icon={
